...
const Team = () => {
  const instructors = [
    ...
    },
    {
      ...
      description: "Especialista em treinamento funcional com foco em mobilidade, equilíbrio e condicionamento geral."
    },
    {
      name: "Patrícia Lima",
      role: "Pilates Terapêutico",
      image: "https://images.pexels.com/photos/5384536/pexels-photo-5384536.jpeg?auto=compress&cs=tinysrgb&w=600",
      description: "Certificada em Pilates clínico, atua com recuperação pós-cirúrgica e prevenção de lesões."
    },
    {
      name: "Roberto Campos",
      role: "Treinamento Cardiovascular",
      image: "https://images.pexels.com/photos/6456141/pexels-photo-6456141.jpeg?auto=compress&cs=tinysrgb&w=600",
      description: "Especialista em programas para emagrecimento, performance esportiva e saúde cardiovascular."
    }
  ];

  return (
    <section id="equipe" className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4">
          ...
          {instructors.map((instructor, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h4 className="text-blue-600 font-medium mb-4">{instructor.role}</h4>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-300 mb-6">Nossa equipe está pronta para te ajudar a alcançar seus objetivos</p>
          <a 
            href="#contato" 
